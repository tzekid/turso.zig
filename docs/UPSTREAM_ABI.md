...
This release audit is pinned to final annotated tag `v0.7.0` (tag object
`c401a2e44e1a3b0435b4e8d5501e945283d2ba10`) and its peeled source commit
`e7cb62a8bd2f3655a661a621ee389365c1a1e43e`. Links below use that immutable
...
2. The two public headers, [`sdk-kit/turso.h`](https://github.com/tursodatabase/turso/blob/e7cb62a8bd2f3655a661a621ee389365c1a1e43e/sdk-kit/turso.h)
   and [`sync/sdk-kit/turso_sync.h`](https://github.com/tursodatabase/turso/blob/e7cb62a8bd2f3655a661a621ee389365c1a1e43e/sync/sdk-kit/turso_sync.h).
...
- Base: [`sdk-kit/Cargo.toml:16-18`](https://github.com/tursodatabase/turso/blob/e7cb62a8bd2f3655a661a621ee389365c1a1e43e/sdk-kit/Cargo.toml#L16-L18), native name `turso_sdk_kit`.
- Sync: [`sync/sdk-kit/Cargo.toml:13-15`](https://github.com/tursodatabase/turso/blob/e7cb62a8bd2f3655a661a621ee389365c1a1e43e/sync/sdk-kit/Cargo.toml#L13-L15), native name `turso_sync_sdk_kit`.
...
([base script](https://github.com/tursodatabase/turso/blob/e7cb62a8bd2f3655a661a621ee389365c1a1e43e/sdk-kit/bindgen.sh),
[sync script](https://github.com/tursodatabase/turso/blob/e7cb62a8bd2f3655a661a621ee389365c1a1e43e/sync/sdk-kit/bindgen.sh)).
...
- `turso_slice_ref_t` never transfers ownership
  ([`turso.h:8-17`](https://github.com/tursodatabase/turso/blob/e7cb62a8bd2f3655a661a621ee389365c1a1e43e/sdk-kit/turso.h#L8-L17)).
...
- Any C string returned as an error, column name/type, or parameter name is a
  ...
  freed ([`turso.h:173-175`](https://github.com/tursodatabase/turso/blob/e7cb62a8bd2f3655a661a621ee389365c1a1e43e/sdk-kit/turso.h#L173-L175)).

### Status and native messages

The numeric status ABI is fixed by
[`turso.h:19-36`](https://github.com/tursodatabase/turso/blob/e7cb62a8bd2f3655a661a621ee389365c1a1e43e/sdk-kit/turso.h#L19-L36):
...
([`turso.h:190-197`](https://github.com/tursodatabase/turso/blob/e7cb62a8bd2f3655a661a621ee389365c1a1e43e/sdk-kit/turso.h#L190-L197)).
...
Statement exclusive
([`turso.h:161-171`](https://github.com/tursodatabase/turso/blob/e7cb62a8bd2f3655a661a621ee389365c1a1e43e/sdk-kit/turso.h#L161-L171)).
...
([`turso.h:355-362`](https://github.com/tursodatabase/turso/blob/e7cb62a8bd2f3655a661a621ee389365c1a1e43e/sdk-kit/turso.h#L355-L362)).
...
- A current row exists only after `ROW`. Text/blob pointers are borrowed until
  ...
  ([`turso.h:471-483`](https://github.com/tursodatabase/turso/blob/e7cb62a8bd2f3655a661a621ee389365c1a1e43e/sdk-kit/turso.h#L471-L483)).
...
([`turso.h:131-150`](https://github.com/tursodatabase/turso/blob/e7cb62a8bd2f3655a661a621ee389365c1a1e43e/sdk-kit/turso.h#L131-L150)).
...
([`turso_sync.h:146-154`](https://github.com/tursodatabase/turso/blob/e7cb62a8bd2f3655a661a621ee389365c1a1e43e/sync/sdk-kit/turso_sync.h#L146-L154)).
...
- `apply_changes` consumes non-null Changes immediately, even if creating or
  ...
  ([`turso_sync.h:238-253`](https://github.com/tursodatabase/turso/blob/e7cb62a8bd2f3655a661a621ee389365c1a1e43e/sync/sdk-kit/turso_sync.h#L238-L253)).
- Stats extraction is non-consuming and may be repeated while the Operation
  ...
  ([`turso_sync.h:82-95`](https://github.com/tursodatabase/turso/blob/e7cb62a8bd2f3655a661a621ee389365c1a1e43e/sync/sdk-kit/turso_sync.h#L82-L95),
