...
A discovery run with `0.17.0-dev.1963+e00c6c439` found:
...
| --- | --- |
| Channel | `main` |
| Commit | `7e2fc39de6ddce1100c5c014ee4b801db49e3ac2` |
| Commit timestamp | `2026-07-30T13:47:25Z` |
| Source epoch | `1788677055` |
| Declared workspace version | `0.8.0-pre.8` |
| Archive URL | `https://github.com/tursodatabase/turso/archive/7e2fc39de6ddce1100c5c014ee4b801db49e3ac2.tar.gz` |
| Zig package hash | `N-V-__8AALsfgQSVmlHnFFr0ZmS7E7bYCwH5lvLVItOsFedK` |
| Base header SHA-256 | `4e68f1979e239c675cfb39975e2f5120f481d6fb91f3777fd06b80a7872280a6` |
