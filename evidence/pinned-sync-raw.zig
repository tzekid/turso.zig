...
pub const turso_database_config_t = extern struct {
    ...
    pub const turso_sync_database_new = __root.turso_sync_database_new;
...
pub const TURSO_SYNC_IO_NONE: c_int = 0;
pub const TURSO_SYNC_IO_HTTP: c_int = 1;
pub const TURSO_SYNC_IO_FULL_READ: c_int = 2;
pub const TURSO_SYNC_IO_FULL_WRITE: c_int = 3;
pub const turso_sync_io_request_type_t = c_uint;
pub const turso_sync_io_http_request_t = extern struct {
    url: turso_slice_ref_t = @import("std").mem.zeroes(turso_slice_ref_t),
    method: turso_slice_ref_t = @import("std").mem.zeroes(turso_slice_ref_t),
    path: turso_slice_ref_t = @import("std").mem.zeroes(turso_slice_ref_t),
    body: turso_slice_ref_t = @import("std").mem.zeroes(turso_slice_ref_t),
    headers: i32 = 0,
};
pub const turso_sync_io_http_header_t = extern struct {
    key: turso_slice_ref_t = @import("std").mem.zeroes(turso_slice_ref_t),
    value: turso_slice_ref_t = @import("std").mem.zeroes(turso_slice_ref_t),
};
pub const turso_sync_io_full_read_request_t = extern struct {
    path: turso_slice_ref_t = @import("std").mem.zeroes(turso_slice_ref_t),
};
pub const turso_sync_io_full_write_request_t = extern struct {
    path: turso_slice_ref_t = @import("std").mem.zeroes(turso_slice_ref_t),
    content: turso_slice_ref_t = @import("std").mem.zeroes(turso_slice_ref_t),
};
pub const TURSO_ASYNC_RESULT_NONE: c_int = 0;
pub const TURSO_ASYNC_RESULT_CONNECTION: c_int = 1;
pub const TURSO_ASYNC_RESULT_CHANGES: c_int = 2;
pub const TURSO_ASYNC_RESULT_STATS: c_int = 3;
pub const turso_sync_operation_result_type_t = c_uint;
pub const struct_turso_sync_changes = opaque {
    pub const turso_sync_changes_deinit = __root.turso_sync_changes_deinit;
    pub const deinit = __root.turso_sync_changes_deinit;
};
pub const turso_sync_changes_t = struct_turso_sync_changes;
pub const turso_sync_stats_t = extern struct {
    cdc_operations: i64 = 0,
    main_wal_size: i64 = 0,
    revert_wal_size: i64 = 0,
    last_pull_unix_time: i64 = 0,
    last_push_unix_time: i64 = 0,
    network_sent_bytes: i64 = 0,
    network_received_bytes: i64 = 0,
    revision: turso_slice_ref_t = @import("std").mem.zeroes(turso_slice_ref_t),
};
pub const turso_sync_database_config_t = extern struct {
    path: [*c]const u8 = null,
    remote_url: [*c]const u8 = null,
    client_name: [*c]const u8 = null,
    long_poll_timeout_ms: i32 = 0,
    bootstrap_if_empty: bool = false,
    reserved_bytes: i32 = 0,
    partial_bootstrap_strategy_prefix: i32 = 0,
    partial_bootstrap_strategy_query: [*c]const u8 = null,
    partial_bootstrap_segment_size: usize = 0,
    partial_bootstrap_prefetch: bool = false,
    remote_encryption_key: [*c]const u8 = null,
    remote_encryption_cipher: [*c]const u8 = null,
    push_operations_threshold: usize = 0,
    pull_bytes_threshold: usize = 0,
    logical_mvcc_pull: bool = false,
};
pub const struct_turso_sync_database = opaque {
    pub const turso_sync_database_open = __root.turso_sync_database_open;
    pub const turso_sync_database_create = __root.turso_sync_database_create;
    pub const turso_sync_database_connect = __root.turso_sync_database_connect;
    pub const turso_sync_database_stats = __root.turso_sync_database_stats;
    pub const turso_sync_database_checkpoint = __root.turso_sync_database_checkpoint;
    pub const turso_sync_database_push_changes = __root.turso_sync_database_push_changes;
    pub const turso_sync_database_wait_changes = __root.turso_sync_database_wait_changes;
    pub const turso_sync_database_apply_changes = __root.turso_sync_database_apply_changes;
    pub const turso_sync_database_io_take_item = __root.turso_sync_database_io_take_item;
    pub const turso_sync_database_io_step_callbacks = __root.turso_sync_database_io_step_callbacks;
    pub const turso_sync_database_deinit = __root.turso_sync_database_deinit;
    pub const open = __root.turso_sync_database_open;
    pub const create = __root.turso_sync_database_create;
    pub const connect = __root.turso_sync_database_connect;
    pub const stats = __root.turso_sync_database_stats;
    pub const checkpoint = __root.turso_sync_database_checkpoint;
    pub const push_changes = __root.turso_sync_database_push_changes;
    pub const wait_changes = __root.turso_sync_database_wait_changes;
    pub const apply_changes = __root.turso_sync_database_apply_changes;
    pub const io_take_item = __root.turso_sync_database_io_take_item;
    pub const io_step_callbacks = __root.turso_sync_database_io_step_callbacks;
    pub const deinit = __root.turso_sync_database_deinit;
};
pub const turso_sync_database_t = struct_turso_sync_database;
pub const struct_turso_sync_operation = opaque {
    pub const turso_sync_operation_resume = __root.turso_sync_operation_resume;
    pub const turso_sync_operation_result_kind = __root.turso_sync_operation_result_kind;
    pub const turso_sync_operation_result_extract_connection = __root.turso_sync_operation_result_extract_connection;
    pub const turso_sync_operation_result_extract_changes = __root.turso_sync_operation_result_extract_changes;
    pub const turso_sync_operation_result_extract_stats = __root.turso_sync_operation_result_extract_stats;
    pub const turso_sync_operation_deinit = __root.turso_sync_operation_deinit;
    pub const @"resume" = __root.turso_sync_operation_resume;
    pub const result_kind = __root.turso_sync_operation_result_kind;
    pub const result_extract_connection = __root.turso_sync_operation_result_extract_connection;
    pub const result_extract_changes = __root.turso_sync_operation_result_extract_changes;
    pub const result_extract_stats = __root.turso_sync_operation_result_extract_stats;
    pub const deinit = __root.turso_sync_operation_deinit;
};
pub const turso_sync_operation_t = struct_turso_sync_operation;
pub const struct_turso_sync_io_item = opaque {
    pub const turso_sync_database_io_request_kind = __root.turso_sync_database_io_request_kind;
    pub const turso_sync_database_io_request_http = __root.turso_sync_database_io_request_http;
    pub const turso_sync_database_io_request_http_header = __root.turso_sync_database_io_request_http_header;
    pub const turso_sync_database_io_request_full_read = __root.turso_sync_database_io_request_full_read;
    pub const turso_sync_database_io_request_full_write = __root.turso_sync_database_io_request_full_write;
    pub const turso_sync_database_io_poison = __root.turso_sync_database_io_poison;
    pub const turso_sync_database_io_status = __root.turso_sync_database_io_status;
    pub const turso_sync_database_io_push_buffer = __root.turso_sync_database_io_push_buffer;
    pub const turso_sync_database_io_done = __root.turso_sync_database_io_done;
    pub const turso_sync_database_io_item_deinit = __root.turso_sync_database_io_item_deinit;
    pub const kind = __root.turso_sync_database_io_request_kind;
    pub const http = __root.turso_sync_database_io_request_http;
    pub const header = __root.turso_sync_database_io_request_http_header;
    pub const read = __root.turso_sync_database_io_request_full_read;
    pub const write = __root.turso_sync_database_io_request_full_write;
    pub const poison = __root.turso_sync_database_io_poison;
    pub const status = __root.turso_sync_database_io_status;
    pub const buffer = __root.turso_sync_database_io_push_buffer;
    pub const done = __root.turso_sync_database_io_done;
    pub const deinit = __root.turso_sync_database_io_item_deinit;
};
pub const turso_sync_io_item_t = struct_turso_sync_io_item;
pub extern fn turso_sync_database_new(db_config: [*c]const turso_database_config_t, sync_config: [*c]const turso_sync_database_config_t, database: [*c]?*const turso_sync_database_t, error_opt_out: [*c][*c]const u8) turso_status_code_t;
pub extern fn turso_sync_database_open(self: ?*const turso_sync_database_t, operation: [*c]?*const turso_sync_operation_t, error_opt_out: [*c][*c]const u8) turso_status_code_t;
pub extern fn turso_sync_database_create(self: ?*const turso_sync_database_t, operation: [*c]?*const turso_sync_operation_t, error_opt_out: [*c][*c]const u8) turso_status_code_t;
pub extern fn turso_sync_database_connect(self: ?*const turso_sync_database_t, operation: [*c]?*const turso_sync_operation_t, error_opt_out: [*c][*c]const u8) turso_status_code_t;
pub extern fn turso_sync_database_stats(self: ?*const turso_sync_database_t, operation: [*c]?*const turso_sync_operation_t, error_opt_out: [*c][*c]const u8) turso_status_code_t;
pub extern fn turso_sync_database_checkpoint(self: ?*const turso_sync_database_t, operation: [*c]?*const turso_sync_operation_t, error_opt_out: [*c][*c]const u8) turso_status_code_t;
pub extern fn turso_sync_database_push_changes(self: ?*const turso_sync_database_t, operation: [*c]?*const turso_sync_operation_t, error_opt_out: [*c][*c]const u8) turso_status_code_t;
pub extern fn turso_sync_database_wait_changes(self: ?*const turso_sync_database_t, operation: [*c]?*const turso_sync_operation_t, error_opt_out: [*c][*c]const u8) turso_status_code_t;
pub extern fn turso_sync_database_apply_changes(self: ?*const turso_sync_database_t, changes: ?*const turso_sync_changes_t, operation: [*c]?*const turso_sync_operation_t, error_opt_out: [*c][*c]const u8) turso_status_code_t;
pub extern fn turso_sync_operation_resume(self: ?*const turso_sync_operation_t, error_opt_out: [*c][*c]const u8) turso_status_code_t;
pub extern fn turso_sync_operation_result_kind(self: ?*const turso_sync_operation_t) turso_sync_operation_result_type_t;
pub extern fn turso_sync_operation_result_extract_connection(self: ?*const turso_sync_operation_t, connection: [*c]?*const turso_connection_t) turso_status_code_t;
pub extern fn turso_sync_operation_result_extract_changes(self: ?*const turso_sync_operation_t, changes: [*c]?*const turso_sync_changes_t) turso_status_code_t;
pub extern fn turso_sync_operation_result_extract_stats(self: ?*const turso_sync_operation_t, stats: [*c]turso_sync_stats_t) turso_status_code_t;
pub extern fn turso_sync_database_io_take_item(self: ?*const turso_sync_database_t, item: [*c]?*const turso_sync_io_item_t, error_opt_out: [*c][*c]const u8) turso_status_code_t;
pub extern fn turso_sync_database_io_step_callbacks(self: ?*const turso_sync_database_t, error_opt_out: [*c][*c]const u8) turso_status_code_t;
pub extern fn turso_sync_database_io_request_kind(self: ?*const turso_sync_io_item_t) turso_sync_io_request_type_t;
pub extern fn turso_sync_database_io_request_http(self: ?*const turso_sync_io_item_t, request: [*c]turso_sync_io_http_request_t) turso_status_code_t;
pub extern fn turso_sync_database_io_request_http_header(self: ?*const turso_sync_io_item_t, index: usize, header: [*c]turso_sync_io_http_header_t) turso_status_code_t;
pub extern fn turso_sync_database_io_request_full_read(self: ?*const turso_sync_io_item_t, request: [*c]turso_sync_io_full_read_request_t) turso_status_code_t;
pub extern fn turso_sync_database_io_request_full_write(self: ?*const turso_sync_io_item_t, request: [*c]turso_sync_io_full_write_request_t) turso_status_code_t;
pub extern fn turso_sync_database_io_poison(self: ?*const turso_sync_io_item_t, @"error": [*c]turso_slice_ref_t) turso_status_code_t;
pub extern fn turso_sync_database_io_status(self: ?*const turso_sync_io_item_t, status: i32) turso_status_code_t;
pub extern fn turso_sync_database_io_push_buffer(self: ?*const turso_sync_io_item_t, buffer: [*c]turso_slice_ref_t) turso_status_code_t;
pub extern fn turso_sync_database_io_done(self: ?*const turso_sync_io_item_t) turso_status_code_t;
pub extern fn turso_sync_database_deinit(self: ?*const turso_sync_database_t) void;
pub extern fn turso_sync_operation_deinit(self: ?*const turso_sync_operation_t) void;
pub extern fn turso_sync_database_io_item_deinit(self: ?*const turso_sync_io_item_t) void;
pub extern fn turso_sync_changes_deinit(self: ?*const turso_sync_changes_t) void;
...
pub const turso_sync_changes = struct_turso_sync_changes;
pub const turso_sync_database = struct_turso_sync_database;
pub const turso_sync_operation = struct_turso_sync_operation;
pub const turso_sync_io_item = struct_turso_sync_io_item;
